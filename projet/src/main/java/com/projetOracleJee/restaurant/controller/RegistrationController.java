...
import com.projetOracleJee.restaurant.event.RegistrationCompleteEvent;
import com.projetOracleJee.restaurant.model.PasswordModel;
import com.projetOracleJee.restaurant.model.UserModel;
import com.projetOracleJee.restaurant.service.UserService;
...
public class RegistrationController {
    ...
    public String verifyRegistration(@RequestParam("token") String token){
        String resultat = userService.validateVerificationToken(token);
